...
public class GameObjectPoolItem
{
	...
	public GameObjectPoolItem(GameObject obj, int amt, bool exp = true)
	{
		objectToPool = obj;
...
public class GameObjectPool : MonoBehaviour
{
	...
	public List<GameObjectPoolItem> itemsToPool;
	...
	{
		GameObjectPoolItem item = new GameObjectPoolItem(GO, amt, exp);
	...
	{
		GameObjectPoolItem item = itemsToPool[index];
