...
namespace com.rainssong.utils
{
    public class ReflectionCore
    {
        ...
        static public object Get(object target, string propertyName)
        {
            return GetFieldOrProperty(target, propertyName);
        }
        ...
        static public void Set(object target, string propertyName, object value)
        {
            if (ReflectionCore.HasProperty(target, propertyName))
            {
