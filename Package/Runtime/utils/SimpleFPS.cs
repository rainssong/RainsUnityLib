...
public class SimpleFPS: MonoBehaviour
{
    ...
    public float offsetFromBottomWhenForcedToLowerLeft = -10.0f;        //40.0f;
         
    void Start()
    {
            if (forceToLowerLeft)
            {
                    Rect lowerLeftRect = new Rect( 0, Screen.height - startRect.height -offsetFromBottomWhenForcedToLowerLeft , 
                            startRect.width, startRect.height);
                    startRect = lowerLeftRect;
            }
        StartCoroutine( FPS() );
    }
